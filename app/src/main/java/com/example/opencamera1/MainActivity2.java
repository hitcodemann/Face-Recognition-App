    ...
    private void createPost(String s) {
        ...
        call.enqueue(new Callback<PostRequest>() {
            ...
            public void onResponse(Call<PostRequest> call, Response<PostRequest> response) {
                Toast.makeText(MainActivity2.this, "Post Successful", Toast.LENGTH_SHORT).show();
    ...
    private void getPosts() {
        ...
        call.enqueue(new Callback<Post>() {
            ...
            public void onResponse(Call<Post> call, Response<Post> response) {
                ...
                Toast.makeText(MainActivity2.this, "This is " + post.getName(), Toast.LENGTH_SHORT).show();
